...
const members = {
    ...
    "01922362569":{
        ...
        payment             :{"01/08/24-DBBL":500,"11/08/24-cash":2000,"15/08/24-DBBL":1000,"27/08/24-DBBL":500},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
    ...
    "01744459622":{
        ...
        payment             :{"02/08/24-Cash":2000,"10/08/24-Cash":3000,"13/08/24-Cash":2000,"24/08/24-Cash":500},
        // running month
        stay_cost       :2700,
        garage_cost     :0,
    ...
    "01780608997":{
        ...
        payment             :{"24/08/24-Nagad":4000,"24/08/24-Dismiss":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
    ...
    "01645122114":{
        ...
        post_payable        :5123,
        previous_paid       :6220,
        previous_dining_cost:2632,
        payment             :{"10/08/24-Bkash":5000,"25/08/24-Cash":1000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
    ...
    "01714443406":{
        ...
        payment             :{"15/08/24-Bkash":3000,"29/08/24-Cash":500},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :2682,
        running_paid    :3500,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01834648400":{
        ...
        post_payable        :2501,
        previous_paid       :4000,
        previous_dining_cost:168,
        payment             :{"01/08/24-Cash":3000},
        // running month
        stay_cost       :2500,
        garage_cost     :0,
    ...
    "01821245430":{
        ...
        previous_paid       :3000,
        previous_dining_cost:0,
        payment             :{"07/08/24-Cash":3500,"16/08/24-Cash":2000,"20/08/24-Cash":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
